...
class _$TokenModelImpl implements _TokenModel {
  const _$TokenModelImpl({this.otpCode, this.token});
  ...
  @override
  String toString() {
    return 'TokenModel(otpCode: $otpCode, token: $token)';
  }
...
abstract class _TokenModel implements TokenModel {
  const factory _TokenModel({final String? otpCode, final String? token}) =
      _$TokenModelImpl;
