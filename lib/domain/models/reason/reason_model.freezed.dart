...
abstract class $ReasonModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String? message, int? order});
}
...
class _$ReasonModelImpl implements _ReasonModel {
  const _$ReasonModelImpl({required this.id, this.message, this.order});
  ...
  @override
  String toString() {
    return 'ReasonModel(id: $id, message: $message, order: $order)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, message, order);
...
abstract class _ReasonModel implements ReasonModel {
  const factory _ReasonModel(
      ...
      final String? message,
      final int? order}) = _$ReasonModelImpl;
